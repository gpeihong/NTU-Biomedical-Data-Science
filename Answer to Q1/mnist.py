...
TRAIN_IMAGES_DIR = "./mnist/train"
TEST_IMAGES_DIR = "./mnist/test"

TRAIN_IMAGE_DATASET_PATH = "./mnist/train-images.idx3-ubyte"
TRAIN_LABEL_DATASET_PATH = "./mnist/train-labels.idx1-ubyte"
TEST_IMAGE_DATASET_PATH = "./mnist/t10k-images.idx3-ubyte"
TEST_LABEL_DATASET_PATH = "./mnist/t10k-labels.idx1-ubyte"
...
def convert_to_image(dataset_type):
    ...
    for i in range(image_num):
        ...
        for j in range(image_row * image_col):
            img.append(int.from_bytes(image_dataset.read(1), byteorder='big', signed=False))
